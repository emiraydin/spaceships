...
public final class GameConstants {
	...
	public static enum ActionType { ResetAsteroids, Move, Initialize, FireCannon, FireTorpedo, DropMine, PickupMine, Explode, TurnLeft, TurnRight, Turn180Left, Turn180Right, Repair, Yes, No, PlaceShip, ToggleRadar}
