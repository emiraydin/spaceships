...
public final class GameConstants {
	...
	public static enum ActionType { Move, Place, FireCannon, FireTorpedo, DropMine, PickupMine, TurnLeft, TurnRight, Turn180Left, Turn180Right, Repair, Yes, No, PlaceShip }
