...
public class TestGameState
{
	...
	public void setUp() throws Exception
	{
		...
		message = new NewTurnMessage(action, true, null, null, radarVisibleTiles, sonarVisibleTiles, 0, 0, null);
		...
		newHealth[0] = 1;
		newHealth[1] = 2;
		message2 = new NewTurnMessage(null, true, null, null, null, radarVisibleTiles, 0, 0, null);
